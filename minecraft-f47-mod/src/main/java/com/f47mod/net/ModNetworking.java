...
public final class ModNetworking {
	...
	/** Aktuelle Radarkontakte fuer die Anzeige im HUD. */
	public record RadarUpdatePayload(List<RadarContact> contacts) implements CustomPayload {
	...
	public static void sendRadar(ServerPlayerEntity player, List<RadarContact> contacts) {
		ServerPlayNetworking.send(player, new RadarUpdatePayload(contacts));
	}
}
